...
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function() {
    var currentlyActiveAccordionButton = document.querySelector(".accordion-btn.active");
    if(currentlyActiveAccordionButton && currentlyActiveAccordionButton !== this) {
      currentlyActiveAccordionButton.classList.remove("active");
